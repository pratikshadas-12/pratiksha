  ...
  return (
    <div>
      ...
      <div>
        ...
        <div>
          ...
          >
            ...
            <br />
            <br />
            For simplicity, we can think of an array as a fleet of stairs where
            on each step is placed a value (let’s say one of your friends).
            Here, you can identify the location of any of your friends by simply
            knowing the count of the step they are on.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        >
          <br />
          <img alt="Text1" src="./resources/A1.jpg" />
          <br />
          ...
          <br />
          <br />
          <img alt="Text1" src="./resources/A2.jpg" />
          <br />
          <br />
          <ol>
            <ul>
              ...
              data in a specific spot. For example, reading for “o” in the array
            ...
            <ul>
              ...
              value in our data structure. For example, removing “H” from hello
              would be ello (side note: deletion of a value h would actually
              involve another step of moving all the characters to left.
            </ul>
            <br />
          </ol>
        </p>
      ...
      <div>
        ...
        >
          An array is always of a fixed size; it does not grow as more elements
          are required. The programmer must ensure that only valid values in the
          array are accessed, and must remember the location in the array of
          each value. Arrays are basic types in most programming languages and
          have a special syntax for their use.
          <br />
          The computational complexity for writing to and accessing an array is
          O(1). No matter the number of elements in the array, the calculation
          to find the element in the array is single multiplication and
          addition.
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        >
          <ol>
            <li>
              {" "}
              <span style={{ fontWeight: "bold" }}> Code Optimization:</span> An
              array allows storing and access of a large number of values by
              writing a small piece of code instead of declaring each variable
              separately.
            </li>
            <br />
            <li>
              ...
              Arrays are one of the most basic data structures and are used for
              processing many algorithms like searching and sorting, maximum and
              minimum values, reversing, etc. in simple and easy ways.
            </li>
            <br />
            <li>
              {" "}
              <span style={{ fontWeight: "bold" }}>Index-Based: </span> Arrays
              use an index-based data structure which helps to identify each of
              the elements in an array easily using the index.
            </li>
            <br />
          </ol>
        </p>
        ...
        >
          <ol>
            <li>
              ...
              This does not allow storing extra data in case of any requirement.
              This may sometimes lead to loss of data if the allocated memory to
              an array is less than required.
            </li>
            <br />
            <li>
              <span style={{ fontWeight: "bold" }}>
            ...
            <br />
            <li>
              <span style={{ fontWeight: "bold" }}> Memory wastage: </span> The
              size of an array is declared at the beginning based on some
              requirement that can’t be changed. So the memory is allocated
              accordingly. But if at a later stage the size requirement becomes
              less then memory wastage happens. For example, for a declared
              array size of 50, if we get only 38 elements to store, there{" "}
            </li>
          </ol>
        </p>
      </div>
      <div>
        ...
        >
          Hence arrays are more efficient and beneficial when compared to linked
          lists and hash tables. They are faster and can be utilized anywhere.
          They store data of similar data types together and can be used
